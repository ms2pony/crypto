 ...
 * 参考论文 Parallel implementation of SM2 elliptic curve cryptography on Intel processors with AVX2
 * 函数test1是论文中的Algorithm5-8的合集，一个完整的26*10的模乘操作(利用伪梅森素数)
 * 函数computer_256是论文中的Algorithm5，一个26*10的模乘操作
 */
#include <immintrin.h>
